...
var _excluded = ["className", "layer", "extraParams", "errorMsg"];
...
var Legend = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Legend, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (extraParams && !(0, _isEqual2["default"])(extraParams, prevProps.extraParams)) {
        this.setState({
    ...
    value: function render() {
      ...
      }, passThroughProps), this.state.legendError ? /*#__PURE__*/React.createElement("div", {
        className: "legend-load-error"
      }, errorMsg) : /*#__PURE__*/React.createElement("img", {
