...
var _excluded = ["className", "icon", "iconName", "tooltip", "tooltipPlacement", "tooltipProps"];
 ...
 */
var SimpleButton = /*#__PURE__*/function (_React$Component) {
  _inherits(SimpleButton, _React$Component);

  var _super = _createSuper(SimpleButton);
  ...
  _createClass(SimpleButton, [{
    ...
    function render() {
      ...
      return /*#__PURE__*/React.createElement(_tooltip["default"], _extends({
        ...
        icon: iconToRender
      }, antBtnProps), antBtnProps.children));
    }
  }]);
