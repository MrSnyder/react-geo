...
var _excluded = ["className", "fitOptions", "constrainViewResolution"];
 ...
 */
var ZoomToExtentButton = /*#__PURE__*/function (_React$Component) {
  _inherits(ZoomToExtentButton, _React$Component);

  var _super = _createSuper(ZoomToExtentButton);
  ...
  _createClass(ZoomToExtentButton, [{
    ...
    function onClick() {
      ...
      if (!extent && (!center || !(0, _isFinite2["default"])(zoom))) {
        _Logger["default"].error('zoomToExtentButton: You need to provide either an extent or a center and a zoom.');
      ...
      var finalFitOptions = _objectSpread(_objectSpread({}, defaultFitOptions), fitOptions);

      if (extent && center && (0, _isFinite2["default"])(zoom)) {
        _Logger["default"].warn('zoomToExtentButton: Both extent and center / zoom are provided. ' + 'Extent will be used in favor of center / zoom');
      }

      if (extent) {
        view.fit(extent, finalFitOptions);
      } else if (center && (0, _isFinite2["default"])(zoom)) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(_SimpleButton["default"], _extends({
