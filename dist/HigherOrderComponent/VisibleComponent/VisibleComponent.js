...
function isVisibleComponent(WrappedComponent) {
  ...
  return /*#__PURE__*/function (_React$Component) {
    ...
    var _super = _createSuper(VisibleComponent);
    ...
    _createClass(VisibleComponent, [{
      ...
      function render() {
        ...
        var _this$props = this.props,
            ...
            passThroughProps = _objectWithoutProperties(_this$props, _excluded); // Check if the current component should be visible or not.
        ...
        return isVisible ? /*#__PURE__*/React.createElement(WrappedComponent, passThroughProps) : null;
      }
    }]);
